  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
       ...
       subtitle: KText(text: 'English',color: HexColor('#FE5B00'),fontWeight: FontWeight.bold,fontSize: 12,),
       ),
       ListTile(
         onTap: ()=>choseTheme(context),
       title: KText(text: 'Theme',color: Colors.black,fontWeight: FontWeight.bold,),
       subtitle: KText(text: 'Light',color: HexColor('#FE5B00'),fontWeight: FontWeight.bold,fontSize: 12,),
       ),
       ListTile(
